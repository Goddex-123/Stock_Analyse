...
# Page config
st.set_page_config(
    page_title="Indian Stock Analyzer - BSE & NSE",
    page_icon="🇮🇳",
    layout="wide",
...
# Indian Stock Data - Expanded List
NIFTY_50_STOCKS = {
    # NIFTY 50 Core
...
SECTOR_INDICES = {
    ...
    "^NIFTYSMCP100": "NIFTY Smallcap 100"
}
